...
const siteContent: Record<Locale, SiteCopy> = {
  en: {
    ...
    description: `Explore how ${APP_NAME} provides a modular full-stack foundation with Angular, Astro, Express, workers, realtime delivery, passwordless identity, a zero-knowledge architecture under review, and the local Themis workflow.`,
  ...
  es: {
    ...
    description: `Descubre cómo ${APP_NAME} ofrece una base full-stack modular con Angular, Astro, Express, workers, realtime, identidad passwordless, una arquitectura zero-knowledge bajo revisión y el workflow local Themis.`,
